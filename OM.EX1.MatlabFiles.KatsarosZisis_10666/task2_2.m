function task2_2(f, alpha, beta, l_start, l_end, l_numOfPoints)
    % Task 2.2 of the 1st Optimization Methods Exercise
    %
    % Inputs: 
    ...
    for i = 1:length(lamda_arr)
        lamda = lamda_arr(i);
        [int_min, int_max, times_calc] = golden_section(f, alpha, beta, lamda);
    ...
    ylabel('Interval [a, b]');
    title('Golden Section: Interval [a, b] vs calculations of f');
    grid on;
end