function [x_k_arr, y_k_arr, num_of_iter, x_min] = steepest_descent_choose_gamma(f, x0, y0, epsilon, gamma)
    % Steepest descent method with constant gamma
    %
    % Inputs: 
    % f: Handle function f
    ...
    fprintf(['Minimum of f with starting points at (%.0f, %.0f) ' ...
        'using the Steepest Descent method, where gamma = %.2f: (%0.5f, %0.5f)\n'], x0, y0, gamma, x_min(1), x_min(2));
end    